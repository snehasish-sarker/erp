...
const props =
    defineProps<CustomerReceiptEditProps>();
...
const statusLabel = computed(
    (): string => {
        return props.customerReceipt.status
            .replaceAll('_', ' ')
            .replace(
                /\b\w/g,
                (
    ...
    <div class="space-y-6">
        ...
        >
            <div>
                ...
                >
                    Update the draft receipt context, invoice
            ...
            <div class="flex items-start gap-3">
                ...
                <div>
                    ...
                    >
                        ...
                        settle Sales Invoices or create any
        ...
        >
            ...
            >
                This receipt has already received a permanent
                document number. Its branch and receipt date
        ...
        <CustomerReceiptForm
            :customer-receipt="props.customerReceipt"
