...
const props =
    defineProps<SupplierDebitNoteCreateProps>();
</script>

<template>
    <Head title="Create Supplier Debit Note" />
    ...
    <div class="space-y-6">
        ...
        >
            <div>
                ...
                >
                    Create a commercial claim against a
                    supplier from a posted Purchase Return
                    and optionally allocate the amount to a
                    Supplier Invoice.
                </p>
            </div>
            ...
            >
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        >
                            Only posted Purchase Returns
                            without an existing Supplier Debit
                            Note are available.
                        </p>
                    </div>
                </div>
            ...
            >
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        >
                            Allocate Supplier Invoice
                        </h2>

                        <p
                            class="mt-1 text-sm text-indigo-700 dark:text-indigo-300"
                        >
                            Link an eligible Supplier Invoice
                            or leave the amount unallocated as
                            an open supplier credit.
                        </p>
                    </div>
                </div>
            </section>
            ...
            >
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        >
                            Review Commercial Values
                        </h2>

                        <p
                            class="mt-1 text-sm text-emerald-700 dark:text-emerald-300"
                        >
                            Review price, discount, tax,
                            allocation, and Purchase Return
                            valuation before saving.
                        </p>
                    </div>
                </div>
            </section>
        ...
        >
            ...
            >
                Saving creates a draft Supplier Debit Note.
                No Supplier Invoice amount is reserved until
                the document is submitted and approved.
            </p>
        </section>
