...
const props = defineProps<{
    categories: ProductCategoryPagination;
...
const filters = reactive<ProductCategoryFilters>({
...
const deletingCategoryId: Ref<number | null> =
    ref(null);
...
const deleteCategory = (
    ...
    const confirmed = window.confirm(
        `Delete category “${category.name} (${category.code})”? Its code and slug will remain reserved. Categories with children cannot be deleted.`,
    );
    ...
    router.delete(
        `/erp/product-categories/${category.id}`,
        {
            preserveScroll: true,
    ...
    <div class="space-y-6">
        ...
        >
            <div>
                ...
                >
                    Manage the tenant-isolated product
                    catalogue hierarchy and display order.
                </p>
            </div>

            <Link
                v-if="can('product_categories.create')"
                href="/erp/product-categories/create"
        ...
        >
            ...
            >
                <div class="sm:col-span-2">
                    ...
                    <input
                        ...
                        type="search"
                        maxlength="120"
                        placeholder="Name, code, slug, or description"
                        ...
                        >
                            ...
                            <td class="px-5 py-4">
                                <span
                                    ...
                                    :class="statusBadgeClass(category.status)"
                                >
                                    {{
                            ...
                            <td class="px-5 py-4">
                                ...
                                >
                                    <Link
                                        v-if="can('product_categories.update')"
                                        :href="`/erp/product-categories/${category.id}/edit`"
                                    ...
                                    <button
                                        v-if="can('product_categories.delete')"
                                        type="button"
            ...
            >
                ...
                >
                    Showing {{ categories.meta.from ?? 0 }}–{{
                ...
                <div class="flex items-center gap-2">
                    <button
                        ...
                        @click="navigate(categories.meta.current_page - 1)"
                    >
                        Previous
                    </button>
