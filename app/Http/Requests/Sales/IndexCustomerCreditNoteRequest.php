...
final class IndexCustomerCreditNoteRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'posting_date_from' => $this->nullableString('posting_date_from'),
            'posting_date_to' => $this->nullableString('posting_date_to'),
            'sort' => $this->filled('sort')
                ? trim((string) $this->input('sort'))
                : 'created_at',
            'direction' => $this->filled('direction')
                ? strtolower(trim((string) $this->input('direction')))
                : 'desc',
