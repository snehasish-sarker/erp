...
final class CustomerLedgerEntry extends Model
{
    ...
    /**
     * @return HasOne<CustomerLedgerEntry, $this>
     */
    ...
    protected static function booted(): void
    {
        static::updating(
            static function (): never {
                throw new LogicException(
                    'Customer ledger entries are immutable and cannot be updated.',
                );
            },
        );
        ...
        static::deleting(
            static function (): never {
                throw new LogicException(
                    'Customer ledger entries are immutable and cannot be deleted.',
                );
            },
        );
    }
