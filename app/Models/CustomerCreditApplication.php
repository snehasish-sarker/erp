...
final class CustomerCreditApplication extends Model
{
    use Auditable;
    use BelongsToTenant;
    use HasFactory;
    ...
    {
        return $this->hasMany(CustomerCreditApplicationLine::class)->orderBy('line_number');
    }
    ...
    public function hasApplicationNumber(): bool
    {
        return filled($this->application_number);
    }
    /** @return array<string, string> */
    protected function casts(): array
    {
        return['tenant_id' => 'integer', 'branch_id' => 'integer', 'customer_id' => 'integer', 'document_number_allocation_id' => 'integer', 'application_date' => 'immutable_date', 'posting_date' => 'immutable_date', 'total_amount' => 'decimal:6', 'receivable_base_amount' => 'decimal:6', 'credit_base_amount' => 'decimal:6', 'exchange_difference_amount' => 'decimal:6', 'revision' => 'integer', 'created_by_user_id' => 'integer', 'submitted_by_user_id' => 'integer', 'approved_by_user_id' => 'integer', 'posted_by_user_id' => 'integer', 'reversed_by_user_id' => 'integer', 'cancelled_by_user_id' => 'integer', 'submitted_at' => 'immutable_datetime', 'approved_at' => 'immutable_datetime', 'posted_at' => 'immutable_datetime', 'reversal_posting_date' => 'immutable_date', 'reversed_at' => 'immutable_datetime', 'cancelled_at' => 'immutable_datetime',];
    }
}