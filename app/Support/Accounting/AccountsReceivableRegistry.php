...
final class AccountsReceivableRegistry
{
    ...
    private const LEDGER_ENTRY_TYPES = ['invoice' => 'Sales Invoice', 'invoice_reversal' => 'Sales Invoice Reversal', 'credit_note' => 'Customer Credit Note', 'credit_note_reversal' => 'Customer Credit Note Reversal', 'receipt' => 'Customer Receipt', 'receipt_reversal' => 'Customer Receipt Reversal', 'refund' => 'Customer Refund', 'refund_reversal' => 'Customer Refund Reversal', 'adjustment' => 'Customer Adjustment', 'adjustment_reversal' => 'Customer Adjustment Reversal',];
    /** @var array<string, string> */
    private const OPEN_ITEM_TYPES = ['invoice' => 'Invoice Receivable', 'credit' => 'Customer Credit', 'receipt' => 'Unallocated Receipt', 'refund' => 'Refund Clearing Receivable', 'adjustment_debit' => 'Debit Adjustment', 'adjustment_credit' => 'Credit Adjustment',];
    /** @var array<string, string> */
    private const OPEN_ITEM_STATUSES = ['open' => 'Open', 'partially_settled' => 'Partially Settled', 'settled' => 'Settled', 'reversed' => 'Reversed',];
    /** @var array<string, string> */
    private const ALLOCATION_TYPES = ['credit_note' => 'Customer Credit Note', 'receipt' => 'Customer Receipt', 'manual' => 'Manual Credit Application', 'refund' => 'Customer Refund', 'adjustment' => 'Adjustment',];
    /** @var array<string, string> */
    private const ALLOCATION_STATUSES = ['applied' => 'Applied', 'reversed' => 'Reversed',];
    /** @return list<string> */
